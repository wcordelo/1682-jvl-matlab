...
function [fileout] = jvl_run2D(config,alpha,flap,aile,elev,rudd,cjet,i,j)
%--------------------------------------------------------------------
...
%   path1 = getenv('PATH');
%   path1 = [path1 ':/Jvl/bin/jvl']; % change as needed for system
%   setenv('PATH', path1);
%   !echo $PATH
%
%--------------------------------------------------------------------
...
fileout = [config 'jet' num2str(i) 'alpha' num2str(j) '.txt']
